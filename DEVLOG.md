...
| 2026-04-09 | 4cd5ad7 | feat: add Task model with types, priorities, auto-triggers | prisma/migrations/add_task_model/migration.sql, prisma/schema.prisma |
| 2026-04-09 | 46398d3 | feat: add task queries, actions, and auto-trigger system | src/lib/actions/task-actions.ts, src/lib/queries/task-queries.ts |
| 2026-04-09 | 217da1b | feat: add tasks page with list, create dialog, sidebar nav | src/app/(dashboard)/tasks/page.tsx, src/components/layout/sidebar.tsx, src/components/tasks/create-task-dialog.tsx, src/components/tasks/task-list.tsx, src/lib/queries/task-queries.ts |
| 2026-04-09 | 3f7dffa | feat: wire auto-triggers to quote and order actions | src/lib/actions/order-actions.ts, src/lib/actions/quote-actions.ts |
| 2026-04-09 | 90f9817 | feat: add client inactivity detection cron job | src/app/api/cron/client-inactivity/route.ts, vercel.json |
| 2026-04-09 | 8d64c0a | feat: add Green Invoice service layer with API client and schema fields | prisma/migrations/20260409120000_add_green_invoice_fields/migration.sql, prisma/schema.prisma, src/lib/services/green-invoice.ts |
| 2026-04-09 | 5ab7fd3 | feat: add Green Invoice connection settings | src/app/(dashboard)/settings/page.tsx, src/components/settings/green-invoice-settings.tsx, src/lib/actions/settings-actions.ts |
| 2026-04-09 | f6eefad | feat: add invoice generation from orders via Green Invoice | src/components/orders/create-invoice-button.tsx, src/components/orders/order-detail.tsx, src/lib/actions/invoice-actions.ts |
| 2026-04-09 | ce22f70 | feat: add Green Invoice payment sync cron | src/app/api/cron/green-invoice-sync/route.ts, vercel.json |
| 2026-04-09 | 7a0c9c3 | fix: date formatting and chart readability improvements | src/components/dashboard/recent-activity.tsx, src/components/dashboard/revenue-chart.tsx, src/components/reports/reports-client.tsx |
| 2026-04-09 | a2c40cc | feat: add Green Invoice financial views — dashboard, reports, client detail | src/app/(dashboard)/clients/[id]/page.tsx, src/app/(dashboard)/page.tsx, src/app/(dashboard)/reports/page.tsx, src/components/clients/client-detail.tsx, src/components/clients/client-financials.tsx, +6 more |
| 2026-04-09 | 9aecb18 | feat: add period selector and sales status KPIs to reports | src/app/(dashboard)/reports/page.tsx, src/components/reports/reports-page-client.tsx, src/lib/queries/report-queries.ts |
| 2026-04-09 | 799e7e7 | feat: quote editing, version tracking, PDF fix, payment terms | prisma/migrations/20260409140000_add_quote_version_payment_terms/migration.sql, prisma/schema.prisma, src/app/(dashboard)/quotes/[id]/edit/page.tsx, src/app/api/pdf/quote/[id]/document.tsx, src/components/quotes/quote-detail.tsx, +2 more |
| 2026-04-09 | 7e1db7a | feat: supplier enhancements — payment terms, purchase orders, supplier invoices | prisma/migrations/20260409160000_supplier_enhancements/migration.sql, src/app/(dashboard)/providers/[id]/page.tsx, src/components/providers/add-supplier-invoice-dialog.tsx, src/components/providers/create-purchase-order-dialog.tsx, src/components/providers/provider-detail.tsx, +10 more |
| 2026-04-09 | 74dcb53 | feat: products vs packages — package toggle, contents, service list badges | prisma/migrations/20260409180000_add_package_items/migration.sql, prisma/schema.prisma, src/app/(dashboard)/services/[id]/page.tsx, src/app/(dashboard)/services/new/page.tsx, src/components/services/service-form.tsx, +4 more |
